Shader "RPG Demo/Character/Wuwa Eye Transparent URP"
{
    Properties
    {
        ...
        _DarkLift ("Dark Area Lift", Range(0, 1)) = 0.25
        _DarkLiftColor ("Dark Lift Color", Color) = (0.45, 0.34, 0.36, 1)
        _WhiteBoost ("White Boost", Range(0, 1)) = 0.1
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(Varyings input) : SV_Target
            {
                ...
                half darkMask = saturate(1.0h - luminance * 2.1h);
                tex.rgb = lerp(tex.rgb, max(tex.rgb, _DarkLiftColor.rgb), darkMask * _DarkLift);

                half whiteMask = smoothstep(0.62h, 1.0h, luminance);
